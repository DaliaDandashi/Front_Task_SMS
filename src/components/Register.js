...
const LNAME_REGEX = /^[A-z][A-z0-9-_]{3,23}$/;
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const v3 = FNAME_REGEX.test(fname);
        const v4 = LNAME_REGEX.test(lname);
        if (!v1 || !v2 || !v3 || !v4) {
            ...
            {success ? (
                ...
                <section>
                    ...
                    <label htmlFor="fname">
                        ...
                        />
                        <p  className={fnameFocus && fname && !validFname ? "instructions" : "offscreen"}>
                    ...
                    <label htmlFor="Lname">
                        ...
                        <button disabled={!validFname || !validLname || !validName || !validPwd || !validMatch ? true : false}>Sign Up</button>
                    </form>
                    <p>
